...
from torch_vqvae_model import VAEDecoder, VQVAE
import glob
...
# def get_vq_model(config_path=os.path.join(cwd, 'tokenizers/model.yaml'),
#                  ckpt_path=os.path.join(cwd, "tokenizers/last.ckpt")):
...
def get_vq_model(ckpt_path=os.path.join(cwd, "tokenizers/8k_xh_ckpt.pth")):
    model = VQVAE()
