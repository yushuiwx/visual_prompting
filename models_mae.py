...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward(self, imgs, visual_tokens=None, mask_ratio=0.75, inpt_mask=None):
        ...
        # print(imgs.shape, latent.shape, mask.shape) [64, 3, 224, 224], [b, L*ratio, 1024], [b, L]
        pred = self.forward_decoder(latent, ids_restore)  # [N, L, p*p*3]
        # print(pred.shape, visual_tokens.shape) #[b, L, 1024], [64, 3, 224, 224]
        # print("=" * 100)
        # torch.Size([64, 50, 1024]) torch.Size([64, 196])
        # [14:11:47.532725] torch.Size([64, 196, 1024]) torch.Size([64, 3, 224, 224])
