...
def evaluate_colorization_in_training(args, model, writer, epoch):
    # with open(os.path.join(args.output_dir, 'log.txt'), 'w') as log:
    #     log.write(str(args) + '\n')
    ...
    ds = DatasetColorization(os.path.join(args.eval_data_dir, 'ImageNet'), image_transform, mask_transform)
